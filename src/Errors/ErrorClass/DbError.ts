...
export class DbError extends BaseError {
    ...
    public toDevResponse(): DbErrorDevResponse {
        return { ...super.toDevResponse(), field: this.field };
    }
}

export class DbErrorFactory {
    public static CreatePrismaClientKnwonRequestError(
    ...
    public static CreatePrismaClientUnknownRequestError(
    ...
    public static CreatePrismaClientRustPanicError(
    ...
    public static CreatePrismaClientInitializationError(
        ...
        return new DbError({
            ...
            context: {
                ...
                retryStatus: error.retryable,
                prismaClientVersion: error.clientVersion,
            },
            field: "undefined",
        });
    }
    public static CreatePrismaClientValidationError(
