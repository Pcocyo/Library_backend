...
// 414 4 URI Too Long        | 415 Unsupported Media Type
...
export type ClientErrorStatusCode = 400 | 401 | 402 | 403 | 404 | 405 | 406 | 407 | 408 | 409 | 
...
export type HttpsStatusCode = InformationalStatusCode | SuccessStatusCode | RedirectionStatusCode |
                              ClientErrorStatusCode | ServerErrorStatusCode;

export type HttpsErrorStatusCode = ClientErrorStatusCode | ServerErrorStatusCode;

export type HttpsSuccessStatusCode = InformationalStatusCode | SuccessStatusCode | RedirectionStatusCode;
