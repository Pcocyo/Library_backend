...
import {
    ClientErrorConstructorParams,
    ClientErrorDevResponse,
    EmailNotFoundParam,
...
export class ClientErrorFactory {
    public static createUnauthorizedRequestError(
        param: UnauthorizedCLientParam,
    ): ClientError {
    ...
    public static createIncorrectPasswordError(
        param: IncorrectPasswordParam,
    ): ClientError {
        return new ClientError({
            field: param.field,
    ...
    public static createEmailNotFoundError(
        param: EmailNotFoundParam,
    ): ClientError {
        return new ClientError({
            field: "email",
    ...
    public static createUserIdNotFoundError(
        param: UserIdNotFoundParam,
    ): ClientError {
        return new ClientError({
            field: "user_id",
    ...
    public static createInvalidClientRequestError(
        param: InvalidClientRequestParam,
    ) {
        return new ClientError({
            field: "",
            message: param.message,
