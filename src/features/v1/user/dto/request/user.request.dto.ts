import { CreateUserRequestSchema, GetUserRequestSchema, LoginUserRequestSchema } from "../../user.schema";
...
export class UpdateUserDto {
    ...
    private constructor(token: AccessTokenPayload, data: { email: string | null; password: string | null }) {
        this.token = token;
        this.data = data;
    }
...
export class AssignLibrarianDto {
    public readonly token: AccessTokenPayload;
    public readonly data: { email: string };
    private constructor(email: string, token: AccessTokenPayload) {
        this.token = token;
        this.data = {
            email: email,
        };
    ...
    public static fromRequest(req: Request) {
        return new AssignLibrarianDto(req.body.email,req.body.authorizedUser,);
    }
}
